...
export class Init1741828235849 implements MigrationInterface {
    name = 'Init1741828235849'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "violations" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by" integer, "updated_at" TIMESTAMP DEFAULT now(), "updated_by" integer, "deleted_at" TIMESTAMP, "deleted_by" integer, "id" SERIAL NOT NULL, "violation_collection_id" integer, CONSTRAINT "PK_a2aa2d655842de3c02315ba6073" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "violation_collection" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by" integer, "updated_at" TIMESTAMP DEFAULT now(), "updated_by" integer, "deleted_at" TIMESTAMP, "deleted_by" integer, "id" SERIAL NOT NULL, "date" TIMESTAMP NOT NULL, "note" text, "creator_id" integer, CONSTRAINT "PK_88906077093c3cb0ff615787e61" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "violation_collection" ADD CONSTRAINT "FK_e0c29a2f1fc9c9e78df82a5ad58" FOREIGN KEY ("creator_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "violation_collection" DROP CONSTRAINT "FK_e0c29a2f1fc9c9e78df82a5ad58"`);
